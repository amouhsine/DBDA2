...
#' Jags.Ybinom.Xnom1fac.Mlogistic
#'
#' @return Nothing. Called for side-effect of defining
#'   global functions genMCMC, smryMCMC, and plotMCMC.
#' @export
#'
#' @import runjags
#'
...
#' Jags.Ybinom.Xnom1fac.Mlogistic()
#'
Jags.Ybinom.Xnom1fac.Mlogistic = function() {
...
# Alternate spellings
Jags_Ybinom_Xnom1fac_Mlogistic = Jags.Ybinom.Xnom1fac.Mlogistic
JagsYbinomXnom1facMlogistic = Jags.Ybinom.Xnom1fac.Mlogistic
